...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "GoogleMaps", url: "https://github.com/dogahe/DogaheMaps/releases/download/1.0.0/GoogleMaps.zip",
    ...
    .binaryTarget(
      name: "GoogleMapsCore", url: "https://github.com/dogahe/DogaheMaps/releases/download/1.0.0/GoogleMapsCore.zip",
    ...
    .binaryTarget(
      name: "GoogleMapsBase", url: "https://github.com/dogahe/DogaheMaps/releases/download/1.0.0/GoogleMapsBase.zip",
